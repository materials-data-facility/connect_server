...
def configure_app_middleware(app: FastAPI) -> None:
    ...
    async def security_and_logging_middleware(request: Request, call_next):
        ...
        # Baseline security headers. The API is served over HTTPS via API
        # Gateway and returns JSON only, so these are unconditional; setdefault
        # lets an individual route override one when it has reason to.
