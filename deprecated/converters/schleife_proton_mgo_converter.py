    ...
    if not metadata:
        ...
        dataset_metadata = {
            ...
            "mdf": {
                ...
                "title": "Schleife Charge Density and Difference in MgO V O",
                ...
                "source_name": "schleife_proton_mgo",
...
#                "year": ,
                ...
                "links": {
                    ...
                    "landing_page": "https://www.globus.org/app/transfer?origin_id=e38ee745-6d04-11e5-ba46-22000b92c6ec&origin_path=%2FSchleife%2Fcharge_density_and_difference_proton_MgO_V_O_v_0.5%2F",
...
#                        "http_host": "https://data.materialsdatafacility.org",
                        ...
                        "path": "/Schleife/charge_density_and_difference_proton_MgO_V_O_v_0.5/",
    ...
    for file_data in tqdm(toolbox.find_files(input_path), desc="Processing files", disable= not verbose):
        ...
        record_metadata = {
            ...
            "mdf": {
                ...
                "title": "Schleife Charge Density and Difference - " + record["chemical_formula"],
