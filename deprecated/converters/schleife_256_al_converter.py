    ...
    if not metadata:
        ...
        dataset_metadata = {
            ...
            "mdf": {
                ...
                "title": "H Projectile in Al: Random Trajectories",
...
#                "year": ,
                ...
                "links": {
                    ...
                    "landing_page": "https://www.globus.org/app/transfer?origin_id=e38ee745-6d04-11e5-ba46-22000b92c6ec&origin_path=%2FSchleife%2F256_Al%2F",
    ...
    for file_data in tqdm(toolbox.find_files(input_path), desc="Processing files", disable= not verbose):
        ...
        record_metadata = {
            ...
            "mdf": {
                ...
                "title": "H Projectile in Al: Random Trajectories - " + record["chemical_formula"],
